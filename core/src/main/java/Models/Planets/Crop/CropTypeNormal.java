...
public enum CropTypeNormal implements CropType {
    ...
    RADISH("Radish", SeedType.RADISH_SEED, new ArrayList<>(Arrays.asList(2, 1, 2, 1)), 6, true, -1, 90, true, 45, List.of(Season.SUMMER), false),
    ...
    SUMMER_SQUASH("SUMMER Squash", SeedType.SUMMER_SQUASH, new ArrayList<>(Arrays.asList(1, 1, 1, 2, 1)), 6, false, 3, 45, true, 63, List.of(Season.SUMMER), false),
